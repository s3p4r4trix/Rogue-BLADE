    ...
    <div class="min-h-screen p-8 text-blue-300 font-mono">
      <div class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-between border-b border-blue-800 pb-4">
          <div>
            <h1 class="text-3xl font-bold text-blue-400 tracking-wider">SYSTEM SETTINGS</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <!-- Player Profile -->
          <div class="bg-[#030014]/95 border border-blue-900/50 p-6 shadow-[0_0_15px_rgba(30,58,138,0.2)]">
          ...
          <!-- UI Theming -->
          <div class="bg-[#030014]/95 border border-blue-900/50 p-6 shadow-[0_0_15px_rgba(30,58,138,0.2)] md:col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <button (click)="setTheme('zenith')" 
                      ...
                      class="border border-blue-900/50 p-4 text-left hover:border-blue-700 transition-colors cursor-pointer group">
                <div class="font-bold mb-1 transition-colors"
                     [class.text-white]="player.theme() === 'zenith'"
                     [class.text-blue-400]="player.theme() !== 'zenith'">
                     ZENITH GLASS
                </div>
                <div class="text-xs" [class.text-blue-300]="player.theme() === 'zenith'" [class.text-blue-600]="player.theme() !== 'zenith'">Sleek, ethereal, frosted effects.</div>
              </button>

              <button (click)="setTheme('ripperdoc')" 
                      [class.border-green-500]="player.theme() === 'ripperdoc'"
                      [class.bg-green-900]="player.theme() === 'ripperdoc'"
                      class="border border-blue-900/50 p-4 text-left hover:border-green-700 transition-colors cursor-pointer group">
                <div class="font-bold mb-1 transition-colors"
                     [class.text-white]="player.theme() === 'ripperdoc'"
                     [class.text-green-500]="player.theme() !== 'ripperdoc'">
                     RIPPERDOC TERMINAL
                </div>
                <div class="text-xs" [class.text-green-300]="player.theme() === 'ripperdoc'" [class.text-blue-600]="player.theme() !== 'ripperdoc'">Gritty, high-contrast CRT styling.</div>
              </button>
              ...
              <button (click)="setTheme('neuromancer')" 
                      ...
                      class="border border-blue-900/50 p-4 text-left hover:border-purple-700 transition-colors cursor-pointer group">
                <div class="font-bold mb-1 transition-colors"
                     [class.text-white]="player.theme() === 'neuromancer'"
                     [class.text-purple-400]="player.theme() !== 'neuromancer'">
                     NEUROMANCER DECK
                </div>
                <div class="text-xs" [class.text-purple-300]="player.theme() === 'neuromancer'" [class.text-blue-600]="player.theme() !== 'neuromancer'">Animated PCB circuitry & electrons.</div>
              </button>
