...
export const COMBAT_CONFIG = {
  ...
  PHYSICS: {
    ...
    POST_STRIKE_DEFLECTION_ANGLE: 0.785, // 45 degrees in radians
    POST_STRIKE_FRICTION_MULT: 0.8,
    BOUNCE_VELOCITY_MULT: -0.2,
    MAX_MOMENTUM_MULTIPLIER: 5.0,
    EMP_GROUNDING_DURATION: 3.0,
    MAX_DEPLOYABLE_WEIGHT: 999,
    MIN_REACTION_TIME_FLOOR: 0.15
  },
