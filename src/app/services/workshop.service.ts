...
export const HARDWARE_INVENTORY = {
  ...
  sensors: [
    { id: 'sens-optical', name: 'Optical Sensors', description: 'Short-range camera array.', range: 120, accuracy: 0.7, unlocksTriggerIds: ['ifEnemyInMeleeRange'], weight: 1 } as Sensor,
    { id: 'sens-bio', name: 'Biosensors', description: 'Organic signature tracking.', range: 160, accuracy: 0.85, unlocksTriggerIds: ['ifEnemyIsOrganic'], weight: 2 } as Sensor,
    { id: 'sens-thermal', name: 'Thermal Sensors', description: 'Infrared heat detection.', range: 200, accuracy: 0.9, unlocksTriggerIds: ['ifEnemyInSight'], weight: 2 } as Sensor,
    { id: 'sens-em', name: 'EM-Sensors', description: 'Detects active energy fields.', range: 240, accuracy: 0.9, unlocksTriggerIds: ['ifEnemyIsShielded'], weight: 3 } as Sensor,
    { id: 'sens-radar', name: 'Radar Array', description: 'Long-range monitoring.', range: 280, accuracy: 0.8, unlocksTriggerIds: ['ifEnemyInSight'], weight: 5 } as Sensor,
    { id: 'sens-lidar', name: 'Lidar Array', description: 'Precision optical targeting.', range: 320, accuracy: 0.98, unlocksTriggerIds: ['ifIncomingProjectile'], weight: 4 } as Sensor
  ],
  blades: [
